...
Chart.types.Line.extend({name:"LineAlt",draw:function(){Chart.types.Line.prototype.draw.apply(this,arguments);var a=this.chart.ctx;a.save(),a.textAlign="center",a.textBaseline="bottom",a.fillStyle=this.options.scaleFontColor;var b=.4*this.scale.xScalePaddingLeft,c=this.chart.height/2;a.translate(b,c),a.rotate(-90*Math.PI/180),a.fillText(this.datasets[0].label,0,0),a.restore()}});